getExtSetting: function() {
  var extLang = {
    'en': {
      ...
      "PROXY_CERITFICATE_EXPIRED": "<span style='font-size:13px;color:#ec0a0a;'>Non-Active. Activate HERE. Pay-As-You-Go!</span>",
      "PROXY_CERITFICATE_VALIDITY": "MEMBER CERT: ",
    ...
    "zh": {
      ...
      "PROXY_LOADING": "正在下載中…",
      "PROXY_CERITFICATE_EXPIRED": "<span style='font-size:13px;color:#ec0a0a;'><s>非活躍。點擊這裡激活會員。即付即用！</span>",
      "PROXY_CERITFICATE_VALIDITY": "會員通行證：",
