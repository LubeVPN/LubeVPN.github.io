g_Lang = {
    'en':{
        ...
        "KEY_PROOF_TIP":"<a name='mailto' style='font-weight: bold;' target='_top'>Click to send certification&nbsp;&nbsp;<i class='fa fa-envelope-o'></i>&nbsp;&nbsp; to mail:</a>",
        "KEY_PROOF_COPYTOCB_AUTH_FINISH":"Message content has been copied. The certification will take effect within 24 hours. Please do not send the application message repeatedly and it will be rejected as spam.",
        //創建好友邀請碼時的對話框標題
        "CREATE_NEW_INVITE":"Create a Friend Invitation Code (FIC)",
        //在「藍色非常小的按鈕」左邊的文字描述介紹（而「藍色非常小的按鈕」是在VPN開關的左手邊的）
        "PANEL_VPNSERVICE":"LubeVPN",
        //撥亮順道VPN的切換鍵後頁面中間彈出的提示
        ...
        //展示LubeVPN公鑰的頁面的頂頭標題文字
        "PANEL_PROXY_TITLE":"Setup LubeVPN CERT",
        // 這個是那個「藍色非常小的按鈕」上面的白色字體上顯示的文字內容
        ...
        //點擊 TAC 鏈接之後，彈出窗口A 的標題第1句話（記得句尾要留一個空格，否則第二句話之始就會缺了一個空格錯了文法）
        ...
        // "PANEL_WV_LOAD_FRIST":"First-time installation might need [s] seconds...", 2020-06-18 修改成
        ...
        // "PANEL_WV_ERRORSITE":"Unable to load the page! ", 2020-06-18 修改成
        ...
        "HELP_CONTENTS":[
            {
                "TIP":"Tip: What if I lose my LubeVPN CERT?",
                "CONTENT":"You will lose whatever access that you hold to the LubeVPN service. No remedy to this problem. You must generate a brand new one and start from scratch.",
            },
            {
                "TIP":"Tip: How to save the messages?",
                "CONTENT":"Chat record are saved on your device for 3 days by default. You can modify the settings to make CIM save your messages up to 1 month. But they cannot be saved or transferred to other devices. Messages on CIM are all essentially self-destructing messages.",
            },
        ],
...
//每次打開應用App第一個彈出的提示信息
    ...
    "zh":{
		...
		"KEY_PROOF_TIP": "<a name='mailto' style='font-weight: bold;' target='_top'>點擊發送認證申請&nbsp;&nbsp;<i class = 'fa fa-envelope-o'></i>&nbsp;&nbsp;郵件：</a>",
		"KEY_PROOF_COPYTOCB_AUTH_FINISH": "郵件內容已復制。認證時間為24小時，請勿重複發送郵件訊息，以免當垃圾郵件處理。",
        ...
        "HELP_CONTENTS":[
            {
                "TIP":"小貼士：通行證書丟失怎麼辦？",
                "CONTENT":"無解。丟了就丟了吧，重新創建一個新的好了。重要的事情丟不了，丟掉的都是不重要的，不是嗎？",
            },
            {
                "TIP":"小貼士：訊息如何儲存？",
                "CONTENT":"默認在使用設備保留3天，可以最長調整到一個月。它無法被轉儲到其他設備，同時轉儲也是沒有意義的。你可以理解爲它是真正意義上的“閱後即焚”。",
            },
        ],
