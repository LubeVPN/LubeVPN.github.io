getExtSetting: function() {
  var extLang = {
    'en': {
      ...
      "PANEL_PROXY_TITLE": "Setup <i class='fa fa-rocket'></i> LubeVPN CERT <i class='fa fa-certificate'></i>",
      ...
      "PROXY_CERITFICATE": "LubeVPN CERT <i class='fa fa-certificate'></i>",
      ...
      "PROXY_HELP_CONTENT": "<div style='font-size:16px;margin-bottom:10px;'>LubeVPN service is based on the latest decentralized technology to manage users, decorrelating users and the service and eliminating the need for phone, email, account ID and passwords. Users authentication, validation <i class='fa fa-check-square-o'></i> and service authorization are only based on a public key certificate system. Your self-generated digital certificate (CERT) <i class='fa fa-certificate'></i>, is an electronic document used to prove the ownership of your Public Key.</div><div style='margin: 10px auto;'><span>Requisition of LubeVPN is very different from others, please carefully follow these instructions: </span><ul style='margin:10px auto;'><li>Find a friend (e.g. Alice) who holds a valid (i.e. unexpired) LubeVPN CERT <i class='fa fa-certificate' style='color:green'></i>. Add Alice as your new Contact in your Citium Instant Messenger (CIM) <i class='fa fa-envelope-o' style='color:blue'></i> via out-of-band authentication.</li><li>Click the <i class='fa fa-files-o'></i> above to create a CERT <i class='fa fa-certificate' style='color:chocolate'></i> of your own, which details will be automatically copied to your device’s clipboard. Paste and send the details via the dialogue box between you and Alice and wait for her to sign <i class='fa fa-pencil-square-o'></i> it. Once Alice signs <i class='fa fa-pencil-square-o'></i> it, you will receive an interactive message button in the dialogue box. You press the button to import <i class='fa fa-pencil-square-o'></i> the signed CERT <i class='fa fa-certificate'></i> to your device.</li><li>Turn on the LubeVPN toggle switch to validate <i class='fa fa-check-square-o'></i> the CERT. Toggle switch turns to green <i class='fa fa-toggle-on' style='color:green'></i> if the authorization succeeds.</li></ul></div><div style='margin: 10px auto;'><span>CERT signed <i class='fa fa-pencil-square-o'></i> by your Citium Contact (most likely be your referrer) lasts for five (5) days only. Further usage can be obtained through talking to our LIVE HELP <i class='fa fa-comments-o'></i>: </span><br><ul style='margin:10px auto;'><li>Click <i class='fa fa-question-circle' style='color:yellow'></i> on the top right corner of this page</li><li>Choose the MEMBER CERT renewal period at the bottom of the FAQ section</li><li>Click the dialogue bubble sign on the top right corn of the page to talk to our LIVE CHAT <i class='fa fa-comments-o'></i> for get further instruction</li></ul>From then on, you can enjoy ultimate anonymity while surfing the web because no one knows who holds which LubeVPN CERT (public key) except the holder. This essentially guarantees the privacy of each user to the greatest extent.</div>",
    ...
    "zh": {
      ...
      "PANEL_PROXY_TITLE": "設立 順道VPN 通行證書 <i class='fa fa-certificate'></i>",
      "PANEL_PROXY_SETTING": "服務設立 / 在線客服",
      "PROXY_PUBKEY": "我的公鑰",
      "PROXY_CERITFICATE": "順道VPN通行證書 <i class='fa fa-certificate'></i>",
      "PROXY_PUBKEY_NO": "<span style='color:#1B9AF7;'>點擊創建我的通行證書 <i class='fa fa-certificate'></i></span>",
      "PROXY_CERITFICATE_NO": "<span style='font-size:13px;color:#1B9AF7;'>點擊獲取順道VPN通行證書 <i class='fa fa-certificate'></i></span>",
      "PROXY_LOADING": "正在下載中…",
      ...
      "PROXY_HELP_CONTENT": "<div style='font-size:16px;margin-bottom:10px;'>順道VPN 服務基於最新的去中心化加密網絡數碼證書技術來將用戶和服務關聯，省去了電話、郵箱、賬號ID和密碼。用戶的認證、驗證和服務授權僅基於一套公鑰證書系統就可以了。你自我創建的數碼證書（“通行證書”）<i class='fa fa-certificate'></i> 是用來認證你的公鑰的所有權。</div><div style='margin: 10px auto;'><span><i class='fa fa-rocket'></i> 順道VPN 的免費試用的申請流程與其他網站有很大的不同，請仔細閱讀以下說明：</span><ul style='margin:10px auto;'><li>找到一位持有有效（即未過期）順道VPN 通行證書 <i class='fa fa-certificate' style='color:green'></i> 的朋友（例如Alice）。</li><li>點擊上面的 <i class='fa fa-files-o'></i>通行證書 <i class='fa fa-certificate'></i> 詳情會自動復制到您的設備剪貼板。通過您和Alice之間的對話框粘貼並發送詳細信息，然後等待她簽署。在Alice簽署 <i class='fa fa-pencil-square-o'></i> 後，你便會在對話框中收到一個互動消息按鈕。</li><li>打開 順道VPN 切換開關，請求認證證書的有效性。</li></ul></div></div><div style='margin: 10px auto;'><span>由你的西蒂姆聯系人（很可能是您的推薦人）簽署 <i class='fa fa-pencil-square-o'></i> 的《通行證書》<i class='fa fa-certificate'></i> 有效期持續只有五（5）天。更多的續時方法可以通過與我們的在線客服人員交談獲得：</span><br><ul style='margin: 10px auto;'><li>點擊頁面右上角的 <i class='fa fa-question-circle' style='color:yellow'></i></li><li>選擇常見問題集最下方的《通行證書》<i class='fa fa-certificate'></i> 續時週期</li><li>點擊頁面右上角 <i class='fa fa-comments-o'></i>，與我們的在線客服對話，以獲得進一步的指導</li></ul>從那時起，您可以在瀏覽網頁時享受到終極的匿名性，因為除了通行證書 <i class='fa fa-certificate'></i> 持有者之外，沒有外人知道誰持有該證書 <i class='fa fa-certificate'></i> 的了，包括 <i class='fa fa-rocket'></i> 順道VPN 從上至下任何一位工作人員都不知道。這在很大程度上保障了每個用戶的隱私。</div>",
