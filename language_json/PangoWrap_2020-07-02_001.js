getExtSetting:function(){
	var extLang = {
		'en':{
			...
			"SWITCH_ONVPN_CONTENT":"This app (Citium Client) is built on an open-source, fully decentralized, permissionless blockchain: Citium. In order for you to receive instant messages timely from other Citium Contact, we highly suggest you click “Switch On” button below so that LubeVPN service or simulated network service is enabled to keep this app running in the background. Once you click “Switch On”, LubeVPN toggle switch in <i class='fa fa-cogs'></i> will appear in color GREEN <i class='fa fa-toggle-on' style='color:green'></i> indicating that LubeVPN service is enabled if you holds an valid (unexpired) LubeVPN CERT <i class='fa fa-certificate'></i>; otherwise, it will appear in color ORANGE <i class='fa fa-toggle-on' style='color:orange'></i> indicating that simulated network service is enabled.<br><br><span style='font-size: 13px;'>You can always disable this startup reminder by toggling off “Simulated Network Startup Reminder” in the in the <i class='fa fa-cogs'></i> > <i class='fa fa-cogs' style='color:pink'></i>.</span>"
		},
		"zh":{
			"APP_NAME": "西蒂姆",
			...
			"SWITCH_ONVPN_CONTENT":"本應用App是基於一個完全去中心化、免准入許可的P2P區塊鏈網絡《西蒂姆》構架的。爲了保障即時聊天通訊及時性和更好的網絡隱私性，請您點擊【開啟】鍵激活順道VPN服務或模擬網絡服務。如果您持有一張有效的（未過期的）順道VPN通行證書 <i class='fa fa-certificate'></i>，位於<i class='fa fa-cogs'></i>的順道VPN切換鍵將開啟並呈現綠色 <i class='fa fa-toggle-on' style='color:green'></i> 代表順道VPN服務被啟用，否則該鍵將呈現橙色 <i class='fa fa-toggle-on' style='color:orange'></i> 代表虛擬網絡服務被啟用。<br><br><span style='font-size: 13px;'>您亦撥熄位於 <i class='fa fa-cogs'></i> 的 【個性化設定】 > 【開啟App提醒開啟模擬網絡】，就可以不再見到本彈出提示框了。</span>"
		}
	};
	return {
		'lang':extLang,
