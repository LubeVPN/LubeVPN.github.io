...
- __*Ephemeral*__. Cleartext messages self-destruct, which preempts [spoliation of evidence](https://en.wikipedia.org/wiki/Spoliation_of_evidence) or data breach due to devices fallen into the wrong hands.
