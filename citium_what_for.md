...
1. **無人可信：密碼系統中的任何權益持份者都邪惡和容易犯錯**
2. **權力腐敗：權益持份者的權利和權力會負面影響某些系統參與者**
3. **加密無用：任何密文的安全程度都不會比其純文本高出太多**
...
3. **Encrypt in Vain: the security level of any ciphertext is not much higher than its plaintext counterpart.**
