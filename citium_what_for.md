...
在西蒂姆的密碼系統生態內進行任何資訊交互，即使是有 **1、系統參與者作惡；2、系統權柄被濫用；或 3、密文被破解**，西蒂姆的框架本身都能讓用戶理直氣壯地否認哪怕是他本人曾經參與過的資訊交互行為。這種 **「可推諉性」** 的安全設計大大降低了任何司法取證或競爭對手偵查西蒂姆內交互的資訊的慾望，因為根本沒人能夠分辨資訊真假和來源。
