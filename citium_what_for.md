...
在西蒂姆的密碼系統生態內進行任何資訊交互，即使是有 **1、系統參與者作惡**；**2、系統權柄被濫用**；和 **3、密文被破解**，西蒂姆用戶都能理直氣壯地否認哪怕是他本人曾經參與過的資訊交互行為。這種 **「可推諉性」** 的安全設計**大大降低了任何偵查取證的慾望**，因為西蒂姆的設計註定其資訊本質真假難辨，不論規模多麼龐大、做工多麼精細的網絡安全取證最終都只會是徒勞無功的。
