...
- <i class='fa fa-toggle-on' style='color:green'></i> 認證 <i class="fa fa-check-square-o"></i> 成功，VPN被授權訪問 <i class='fa fa-rocket'></i>  
- <i class='fa fa-toggle-on' style='color:orange'></i> 認證 <i class="fa fa-check-square-o"></i> 失敗，只能用模擬網絡 <i class='fa fa-key'></i>
...
- <i class='fa fa-toggle-on' style='color:green'></i> Validation <i class="fa fa-check-square-o"></i> succeeded; VPN access authorized <i class='fa fa-rocket'></i>
- <i class='fa fa-toggle-on' style='color:orange'></i> Validation <i class="fa fa-check-square-o"></i> failed; Simulation Network only <i class='fa fa-key'></i>
