...
順道VPN用戶使用安全數字證書（“通行證書”） <i class='fa fa-certificate'></i> 來訪問VPN服務，而不是用戶名/密碼組合。所有有效的《通行證書》<i class='fa fa-certificate' style='color:green'></i> 都是源自用戶自我生成的、未被簽署的《通行證書》<i class='fa fa-certificate' style='color:chocolate'></i>。有兩種有效的 <i class='fa fa-rocket' style='color:DimGrey'></i> 順道VPN的通行證書 <i class='fa fa-certificate' style='color:green'></i>：**被簽署了的而且未過期的免費的通行證書** <i class='fa fa-certificate' style='color:green'></i> 和 **付費了的通行證書** <i class='fa fa-certificate' style='color:gold'></i>。有效的通行證書 <i class='fa fa-certificate' style='color:green'></i> 授權其持有人訪問 <i class='fa fa-rocket' style='color:DimGrey'></i> 順道VPN的服務。付費續時的通行證書  持有者不單享受更高級的 <i class='fa fa-rocket' style='color:DimGrey'></i> 順道VPN服務，每當受薦人續時後，他更 **能賺取可兌換的積分**。詳情請參閱[推薦人計劃](../referral)。

<i class='fa fa-rocket' style='color:DimGrey'></i> LubeVPN users use secure digital certificates (“CERTs”) <i class='fa fa-certificate'></i> to access VPN service instead of username/password combinations. There are two kinds of CERT in <i class='fa fa-rocket' style='color:DimGrey'></i> LubeVPN: **signed free CERT & paid CERT**. A signed and validated but free CERT <i class='fa fa-certificate' style='color:green'></i> authorizes its holder to access a FREE TRIAL of <i class='fa fa-rocket' style='color:DimGrey'></i> LubeVPN. All valid CERT <i class='fa fa-certificate' style='color:green'></i> is orginated from self-generating unsigned CERT <i class='fa fa-certificate' style='color:chocolate'></i>. A **paid CERT holder** not only enjoys a higher level of <i class='fa fa-rocket' style='color:DimGrey'></i> LubeVPN service, but also **earns redeemable points** whenever the referred users renew their CERTs <i class='fa fa-certificate'></i>. Please read the [Referral Program](../referral) for more information.
