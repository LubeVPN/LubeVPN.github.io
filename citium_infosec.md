...
In the following, to help you effectively understand the unique infosec features of Citium, we focus on using only the application of **anonymized instant messenger system** (AIMS).
