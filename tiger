...
During our promotion period, **rates <i class='fa fa-bar-chart'></i>** will be based on the renewal period: the longer the one-time **renewal timeframe <i class='fa fa-calendar'></i>**, the greater the discount and the greater the **traffic quota <i class='fa fa-signal'></i>**, which is reset on every 30th day since the day of activation. The unused leftover traffic quota will not rollover to the next period.
 ...
 {: .box-success}
**<i class='fa fa-film' style='color:red'></i>**：假設的大前提是 <i class='fa fa-sun-o' style='color:DimGrey'></i> 順道VPN會員用戶只用於觀看 YouTube 標準制式的 480p 視頻，而這種制式的視頻約每小時消耗264 MB的VPN流量。那麼，如果會員按30日續時，則可以在每30日享用高達380小時；如果會員按180日續時，則可以在每30日享用高達417小時；如果會員按360日續時，則可以在每30日享用高達455小時。<br>
**<i class='fa fa-film' style='color:red'></i>**: The assumption is that <i class='fa fa-sun-o' style='color:DimGrey'></i> LubeVPN members only use the YouTube standard 480p video format, which consumes about 264 MB of VPN traffic. So, if you are a 30-Day member, you can enjoy up to 380 hours for every 30 days; if you are a 180-Day memberr, you can enjoy up to 417 hours for every 30 days; and if you are a 360-Day member, you can enjoy up to 455 hours for every 30 days.

### <i class='fa fa-shopping-cart'></i> 續時抵值形式<br>Payment Methods

<i class='fa fa-sun-o' style='color:DimGrey'></i> 順道VPN用戶可以通過多種 __抵值形式__ 來 __續時__（延長接受服務的週期）。暫時提供給用戶續時的抵值形式有：

Users can use choose from several methods to renew in order to extend the usage of <i class='fa fa-sun-o' style='color:DimGrey'></i> LubeVPN:
...
由 <i class='fa fa-sun-o' style='color:DimGrey'></i> 順道VPN 為您帶來的奈飛特別折扣：從 <i class='fa fa-video-camera'></i> 奈飛 (Netflix) 官方價格起五折優惠！所有家庭計劃提供**奈飛高級超高清** (Netflix Premium Ultra HD, 4K) 流媒體服務，全球直接來自官方奈飛！
...
Netflix special discount brought to you by <i class='fa fa-sun-o' style='color:DimGrey'></i> LubeVPN: 50% OFF from <i class='fa fa-video-camera'></i> Netflix official price!
...
### <i class='fa fa-mixcloud'></i> 中國大陸境內看奈飛<br><i class='fa fa-video-camera'></i> Netflix + <i class='fa fa-sun-o'></i> LubeVPN
...
每一個捆綁計劃都已經包含了上面相應計劃中的所有服務功能。新增的 <i class='fa fa-sun-o' style='color:DimGrey'></i> 順道VPN服務可以讓您在中國大陸境內或境外都能流暢地訪問奈飛流媒服務。每一個捆綁計劃都有30天一個計算週期的VPN流量配額 <i class='fa fa-signal'></i>，自激活之日起，每30天重置一次。未使用的剩余流量配額將不會被轉入下一個30天的計算週期。

- **單月捆綁家庭計劃 (18.45 USD)**:
  - <i class='fa fa-video-camera'></i> 奈飛高級超高清 1个月
  - <i class='fa fa-sun-o' style='color:DimGrey'></i> 順道VPN 30-日 <i class='fa fa-signal'></i> 100 GB
- **半年捆綁家庭計劃 (88.70 USD)**:
  - <i class='fa fa-video-camera'></i> 奈飛高超超高清 6个月
  - <i class='fa fa-sun-o' style='color:DimGrey'></i> 順道VPN 180-日 <i class='fa fa-signal'></i> 110 GB
- **全年捆綁家庭計劃 (148.80 USD)**:
  - <i class='fa fa-video-camera'></i> 奈飛高級超高清 12个月
  - <i class='fa fa-sun-o' style='color:DimGrey'></i> 順道VPN 360-日 <i class='fa fa-signal'></i> 120 GB
...
- **Bundled Plan Jr. (18.45 USD)**:
  - <i class='fa fa-video-camera'></i> Netflix Premium 1 Month
  - <i class='fa fa-sun-o' style='color:DimGrey'></i> LubeVPN 30-Day <i class='fa fa-signal'></i> 100 GB
- **Bundled Plan Plus (88.70 USD)**:
  - <i class='fa fa-video-camera'></i> Netflix Premium 6 Months
  - <i class='fa fa-sun-o' style='color:DimGrey'></i> LubeVPN 180-Day <i class='fa fa-signal'></i> 110 GB
- **Bundled Plan Jumbo (148.80 USD)**:
  - <i class='fa fa-video-camera'></i> Netflix Premium 12 Months
  - <i class='fa fa-sun-o' style='color:DimGrey'></i> LubeVPN 360-Day <i class='fa fa-signal'></i> 120 GB
